...
class ComponentController extends Controller
{
    ...
    /**
     * Display a timeline2 of the resource.
     *
     * @return \Illuminate\View\View
     */
    public function timelineTwo()
    {

        $pageTitle = 'Timeline 2';
        $pageDescription = 'Some description for the page';

        return view('components.timeline2', compact('pageTitle', 'pageDescription'));
    }

    /**
     * Display a timeline3 of the resource.
     *
     * @return \Illuminate\View\View
     */
    public function timelineThree()
    {

        $pageTitle = 'Timeline 3';
        $pageDescription = 'Some description for the page';

        return view('components.timeline3', compact('pageTitle', 'pageDescription'));
    }
