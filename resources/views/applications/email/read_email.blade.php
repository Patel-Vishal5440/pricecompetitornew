        ...
        <div class="container-fluid">
            <div class="mailbox-wrapper">
                <div class="row">
                    ...
                    @include('applications.email.compose')
                    <!-- ends: .col-lg-2 -->
                    <div class="col-lg-10">
                                        ...
                                        <div class="mailbox-top d-flex justify-content-between align-items-center">
                                            <div class="mailbox-top__left">
                                                <ul class="mailbox-top__actions d-flex align-items-center">
                                                    <li class="mr-0">
                                                        <a class="fs-15 color-gray"
                                                            href="{{ route('applications.email') }}">
                                                            <i
                                                                class="las la-arrow-left wh-38 d-flex align-items-center justify-content-start"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action active" href="" data-toggle="tooltip"
                                                            data-placement="bottom" title="Archive">
                                                            <span data-feather="archive"></span></a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action" href="" data-toggle="tooltip"
                                                    ...
                                                    <li>
                                                        <a class="icon-action" href="" data-toggle="tooltip"
                                                            data-placement="bottom" title="Folder">
                                            ...
                                            <div class="mailbox-top__right d-flex align-items-center">
                                                <div class="mailbox-top__extra d-flex align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" class="ellipsis-more" role="button"
                                                            id="ellipsis-more" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="true">
                                                            <span data-feather="more-vertical"></span>
                                                        </a>
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            aria-labelledby="ellipsis-more">
                                        ...
                                        <div class="mail-read-content">
                                                                ...
                                                                <div class="author-info">
                                                                    ...
                                                                    <a class="mail-info-btn">To me
                                                                        ...
                                                                        <ul class="mail-info">
                                                                            <li>
                                                                                <span
                                                                                    class="mail-info__label">from:</span>
                                                                                <span
                                                                                    class="mail-info__text">sample@gmail.com</span>
                                                                            </li>
                                                                            <li>
                                                                                <span
                                                                                    class="mail-info__label">to:</span>
                                                                                <span
                                                                                    class="mail-info__text">sample2@gmail.com</span>
                                                                            </li>
                                                                            <li>
                                                                                <span
                                                                                    class="mail-info__label">cc:</span>
                                                                                <span
                                                                                    class="mail-info__text">example@gmail.com</span>
                                                                            </li>
                                                                            <li>
                                                                                <span
                                                                                    class="mail-info__label">date:</span>
                                                                                <span class="mail-info__text">Jan
                                                                                    2,2020,5:22 PM</span>
                                                                            </li>
                                                                            <li>
                                                                                <span
                                                                                    class="mail-info__label">Subject:</span>
                                                                                <span class="mail-info__text">Late
                                                                                    Entry</span>
                                                                            </li>
                                                                        </ul>
                                                                    </a>
                                            ...
                                            <div class="mail-reply">
                                                <div class="mail-reply__single">
                                                    <div class="mail-details__content mdc media">
                                                        <div class="mdc__left">
                                                            <img src="{{ asset('img/author/3.jpg') }}"
                                                                alt="mail author">
                                                        </div>
                                                        <div class="mdc__right media-body">
                                                            <div class="mdc__head d-flex justify-content-between">
                                                            ...
                                                            <div class="mdc__body">
                                                                <p>
                                                                    ...
                                                                    elitr, sed diam nonumy eirmod tempor inviduntLorem
                                                                    ipsum dolor...
                                                                </p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="mail-reply__action d-flex">
                                                    <a href="#" class="btn btn-outline-lighten btn-md"><span
                                                            data-feather="corner-up-left"></span>Reply</a>
                                                    <a href="#" class="btn btn-outline-lighten btn-md"><span
                                                            data-feather="corner-up-right"></span>Forword</a>
                                                </div>
                                                            ...
                                                            <form action="#">
                                                                <div class="mailCompose-form-content">
                                                                    <div class="form-group positon-relative">
                                                                        ...
                                                                        <select name="reply-to" id="reply-to"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea name="message" id="mail-reply-message"
                                                                            class="form-control-lg"
                                                                            placeholder="Type your message..."></textarea>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="reply-form__action d-flex justify-content-between align-items-center">
                                                                    <div
                                                                        class="reply-form__left d-flex align-items-center">
                                                                        <button
                                                                            class="btn btn-md btn-primary btn-send">Send</button>
                                                                        <a href="#">
