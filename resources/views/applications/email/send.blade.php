                            ...
                            <div class="mailbox-list">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($email_info as $key => $email)
                                        <div class="mailbox-list__content">
                                            <div
                                                class="mailbox-list__single d-flex justify-content-between {{ ($key==3 ? 'attach-file' : '') }}">
                                                <div class="mail-authorBox d-flex">
                                                    <div class="checkbox-theme-default custom-checkbox">
                                                        <input class="checkbox" type="checkbox" id="mail-3">
                                                        <label for="mail-3"></label>
                                                    </div>
                                                    <a href="#" class="star-toggle {{ ($email->star ? 'stared' : '' ) }}">
                                                        <i class="lar la-star"></i>
                                                    </a>
                                                    <span class="auhor-info">
                                                        <img src="{{ asset($email->image) }}" alt="admin author">
                                                        <span class="author-name">{{ $email->user }}</span>
                                                    </span>
                                                </div>
                                                <div class="mail-content">
                                                    <div class="mail-content__top">
                                                        <h6 class="mail-title">
                                                            <a href="{{ route('applications.readEmail') }}">Email
                                                                subject lorem ipsum</a>
                                                            <span
                                                                class="badge badge-transparent badge-round">Inbox</span>
                                                        </h6>
                                        ...
                                        @endforeach
                                        @include('applications.email.mail_compose_body')
