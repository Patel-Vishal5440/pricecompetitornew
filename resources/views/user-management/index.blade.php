        ...
        dom: 'rt<"bottom d-flex justify-content-between align-items-center flex-wrap gap-2"l<"user-management-table-count-info text-center flex-grow-1 small fw-semibold text-primary">p><"clear">',
                language: {
                    emptyTable: `<div class="py-4 text-center text-muted">
                        ...
                        <span style="font-size: 1.1em;">No users found.</span>
                    </div>`,
                },
                ajax: {
                ...
                columns: [
                    { data: 'email', name: 'email', className: 'text-center', width: '200px' },
                    { data: 'role', name: 'role.name', className: 'text-center', width: '150px' },
                    { data: 'company', name: 'company_name', className: 'text-center', width: '150px' },
