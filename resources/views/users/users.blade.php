    ...
    <div class="contents">
        <div class="container-fluid ">
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main user-member justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            ...
                            <form action="{{ route('applications.users.users') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2">
            ...
            <div class="user-card2">
                <div class="row">
                    @foreach($users_grid_style as $user)
                    <div class="cos-xl-2 col-lg-4 mb-25 col-sm-6">
                        <div class="card profile-card-3">
                            <div class="background-block">
                                <img src="{{ asset($user->cover_photo) }}" alt="profile-sample1"
                            ...
                            <div class="card-content mt-n25">
                                <div class="card-content__body mt-n40 pt-0">
                                    ...
                                    <div class="ap-nameAddress pb-3 pt-10">
                                        ...
                                        <p class="ap-nameAddress__subTitle fs-14 pt-1 m-0">{{ $user->position }}</p>
                                    </div>
                                    <div
                ...
                {!! $users_grid_style->links('vendor.pagination.custom') !!}
            </div>
        </div>
    </div>
@endsection
