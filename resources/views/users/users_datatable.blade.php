...
@section('content')
    <div class="contents">
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main user-member justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            ...
                            <form action="{{ route('applications.users.usersDatatable') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2">
                                <span data-feather="search"></span>
                                <input class="form-control mr-sm-2 border-0 box-shadow-none" type="text" name="search"
                                ...
                                <tr>
                                            ...
                                            <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                <div class="checkbox-group-wrapper">
                                                    <div class="checkbox-group d-flex">
                                                        <div
                                                            class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                            <input class="checkbox" type="checkbox" id="check-grp-{{$key+1}}">
                                                            <label for="check-grp-{{$key+1}}"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                   style="background-image:url('{{ asset($user->image) }}'); background-size: cover;"></a>
                                            </div>
                                    ...
                                    <td>
                                        <div class="userDatatable-content d-inline-block">
                                            ...
                                            <span class="bg-opacity-success color-success rounded-pill userDatatable-content-status active">{{ $user->status }}</span>
                                            @elseif($user->status=='Deactive')
                                            <span class="bg-opacity-warning  color-warning rounded-pill userDatatable-content-status active">{{ $user->status }}</span>
                                            @else 
                                            <span class="bg-opacity-danger  color-danger rounded-pill userDatatable-content-status active">{{ $user->status }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td>
            ...
            {!! $users_list->links('vendor.pagination.custom') !!}
        </div>
    </div>
