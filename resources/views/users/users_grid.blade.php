            ...
            <div class="col-lg-12">
                <div class="breadcrumb-main user-member justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        ...
                        <form action="{{ route('applications.users.usersGrid') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2">
                            <span data-feather="search"></span>
                            <input class="form-control mr-sm-2 border-0 box-shadow-none" type="text"
                                placeholder="Search by Name" name="search" aria-label="Search">
                        </form>
                    </div>
                        ...
                        <div class="account-profile-cards  ">
                            <div class="ap-img d-flex justify-content-center">
                                ...
                                <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                    src="{{ asset($grid->image) }}" alt="profile">
                            </div>
                            <div class="ap-nameAddress">
                                <h6 class="ap-nameAddress__title">{{ $grid->name }}</h6>
                                <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">{{ $grid->position }}</p>
                            </div>
                            <div
                                ...
                                <button type="button"
                                    class="border text-capitalize px-25 color-gray transparent shadow2 follow radius-md">
                        ...
                        <div class="card-footer mt-20 pt-20 pb-20 px-0">
                            <div class="profile-overview d-flex justify-content-between flex-wrap">
                                <div class="po-details">
                                    <h6 class="po-details__title">{{ $grid->total_revenue }}</h6>
                                    <span class="po-details__sTitle">Total Revenue</span>
                                </div>
                                <div class="po-details">
                                    <h6 class="po-details__title">{{ $grid->orders }}</h6>
                                    <span class="po-details__sTitle">order</span>
                                </div>
                                <div class="po-details">
                                    <h6 class="po-details__title">{{ $grid->products }}</h6>
