...
<div class="contents">
   <div class="container-fluid ">
         ...
         <div class="col-lg-12">
            <div class="breadcrumb-main user-member justify-content-sm-between ">
               <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                  ...
                  <form action="{{ route('applications.users.usersGroup') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2">
                     <span data-feather="search"></span>
                     <input class="form-control mr-sm-2 border-0 box-shadow-none" type="text" name="search" placeholder="Search by Name" aria-label="Search">
                  </form>
               </div>
               ...
               <div class="border-bottom">
                  <div class="media user-group-media d-flex justify-content-between">
                     <div class="media-body d-flex align-items-center">
                        <img class="mr-20 wh-70 rounded-circle bg-opacity-primary" src="{{ asset($user->image) }}" alt="author">
                        <div>
                           <a href="{{ route('applications.users.usersGrid') }}">
                              <h6 class="mt-0  fw-500">{{ $user->title }}</h6>
                           </a>
                           <p class="fs-13 color-light mb-0">{{ $user->location }}</p>
                        </div>
                     </div>
                     <div class="mt-n15">
               ...
               <div class="user-group-project">
                  <div class="d-flex justify-content-between user-group-progress-top">
                     <div>
                        ...
                        <p class="fs-14 fw-500 color-dark mb-0">{{ $user->current_project }}</p>
                     </div>
                     <div>
                        <span class="color-light fs-12">Project Completed</span>
                        <p class="fs-16 fw-500 color-success mb-0 text-right">{{ $user->complete_status }}</p>
                     </div>
                  </div>
      ...
      {!! $users_group->links('vendor.pagination.custom') !!}
   </div>
</div>
@endsection