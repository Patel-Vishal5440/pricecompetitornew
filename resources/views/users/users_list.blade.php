                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main user-member justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            ...
                            <form action="{{ route('applications.users.usersList') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2">
                    ...
                    <div class="media  py-30  pl-30 pr-20 bg-white radius-xl users-list ">
                        ...
                        <div class="media-body d-xl-flex users-list-body">
                            <div class="flex-1 pr-xl-30 users-list-body__title">
                                ...
                                <p class="mb-0">{{ $user->aboutus }}</p>
                                <div class="users-list-body__bottom">
                                    <span><span class="fw-600">{{ $user->per_hour }}/</span>hr</span>
                                    <span class="ml-15"><span class="fw-600">${{ $user->earned }}K </span>earned</span>
                                </div>
                            </div>
